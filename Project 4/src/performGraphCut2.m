...
main_CV('graph_cut_based_algs/static_images/60x_02.tif',...
    'graph_cut_based_algs/algorithm2/results/60x_02.tif');
pause
main_CV('graph_cut_based_algs/static_images/Blue0001.tif',...
    'graph_cut_based_algs/algorithm2/results/Blue0001.tif');
pause
...
for i = 2001:2150
    ...
    outputname = sprintf('graph_cut_based_algs/algorithm2/results/sequence/MitoGFP_LgtGal4_a01r01s0%d.tif',i);
